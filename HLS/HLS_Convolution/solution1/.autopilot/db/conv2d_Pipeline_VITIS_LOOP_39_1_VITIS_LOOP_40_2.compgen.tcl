...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { out_image_x_address0 { O 14 vector } out_image_x_ce0 { O 1 bit } out_image_x_we0 { O 1 bit } out_image_x_d0 { O 11 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_in_image \
    op interface \
    ports { in_image { I 64 vector } } \
} "
}
