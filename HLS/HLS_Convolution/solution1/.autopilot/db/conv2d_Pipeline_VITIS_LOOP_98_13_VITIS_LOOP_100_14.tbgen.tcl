set moduleName conv2d_Pipeline_VITIS_LOOP_98_13_VITIS_LOOP_100_14
set isTopModule 0
...
set C_modelName {conv2d_Pipeline_VITIS_LOOP_98_13_VITIS_LOOP_100_14}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "out_image","offset": { "type": "dynamic","port_name": "out_image","bundle": "CTRL"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "out_image", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "out_image_sobel", "interface" : "memory", "bitwidth" : 13, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln98", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ out_image sc_in sc_lv 64 signal 1 } 
	{ out_image_sobel_address0 sc_out sc_lv 14 signal 2 } 
	{ out_image_sobel_ce0 sc_out sc_logic 1 signal 2 } 
	{ out_image_sobel_q0 sc_in sc_lv 13 signal 2 } 
	{ zext_ln98 sc_in sc_lv 16 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out_image", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "out_image", "role": "default" }} , 
 	...
 	{ "name": "zext_ln98", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "zext_ln98", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.udiv_23ns_16ns_8_27_1_U12", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "15909", "Max" : "15909"}
	, {"Name" : "Interval", "Min" : "15909", "Max" : "15909"}
]}
...
set Spec2ImplPortList { 
	...
	out_image { ap_none {  { out_image in_data 0 64 } } }
	...
	zext_ln98 { ap_none {  { zext_ln98 in_data 0 16 } } }
}
