...
HLS_SOURCES = ../../../sources/conv2d_tb.c ../../../sources/conv2d.c
...
$(ObjDir)/conv2d_tb.o: ../../../sources/conv2d_tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../sources/conv2d_tb.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) -std=gnu99 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/conv2d_tb.d

$(ObjDir)/conv2d.o: ../../../sources/conv2d.c $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../sources/conv2d.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
