# 1 "HLS_Pooling/sources/pooling.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 360 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "HLS_Pooling/sources/pooling.c" 2
...
# 2 "HLS_Pooling/sources/pooling.c" 2
...
#pragma pack(pop)
# 3 "HLS_Pooling/sources/pooling.c" 2
...
__attribute__((sdx_kernel("Pooling", 0))) void Pooling(
  uint8_t in_image[128][128],
  uint8_t max_pool_image[64][64],
  uint8_t min_pool_image[64][64])
{
#line 17 "C:/DevWorks_HLS/Convolution_Project/HLS/HLS_Pooling/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=Pooling
# 14 "HLS_Pooling/sources/pooling.c"

#line 7 "C:/DevWorks_HLS/Convolution_Project/HLS/HLS_Pooling/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=Pooling
# 14 "HLS_Pooling/sources/pooling.c"
...
#pragma HLS INTERFACE s_axilite port=return bundle=CTRL
 ...
 Loop_row_1: for (int row = 0; row < 128; row += 2)
    {
#pragma HLS PIPELINE OFF

 Loop_col_1: for (int col = 0; col < 128; col += 2)
       {
#pragma HLS PIPELINE OFF
