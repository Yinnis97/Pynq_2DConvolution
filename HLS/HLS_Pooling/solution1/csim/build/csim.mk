...
HLS_SOURCES = ../../../sources/pooling_tb.c ../../../sources/pooling.c
...
$(ObjDir)/pooling_tb.o: ../../../sources/pooling_tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../sources/pooling_tb.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) -std=gnu99 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/pooling_tb.d

$(ObjDir)/pooling.o: ../../../sources/pooling.c $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../sources/pooling.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
