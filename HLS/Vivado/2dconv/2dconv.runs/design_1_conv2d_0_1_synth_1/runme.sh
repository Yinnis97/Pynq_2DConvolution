...
HD_PWD='C:/DevWorks_HLS/Convolution_Project/Vivado/2dconv/2dconv.runs/design_1_conv2d_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_conv2d_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_conv2d_0_1.tcl
