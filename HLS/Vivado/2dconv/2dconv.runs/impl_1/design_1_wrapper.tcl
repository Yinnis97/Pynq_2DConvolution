namespace eval ::optrace {
  variable script "C:/DevWorks_HLS/Convolution_Project/Vivado/2dconv/2dconv.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir C:/DevWorks_HLS/Convolution_Project/Vivado/2dconv/2dconv.cache/wt [current_project]
  set_property parent.project_path C:/DevWorks_HLS/Convolution_Project/Vivado/2dconv/2dconv.xpr [current_project]
  set_property ip_repo_paths C:/DevWorks_HLS/Convolution_Project/HLS_Convolution/solution1/impl/ip [current_project]
  update_ip_catalog
  set_property ip_output_repo C:/DevWorks_HLS/Convolution_Project/Vivado/2dconv/2dconv.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/DevWorks_HLS/Convolution_Project/Vivado/2dconv/2dconv.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files C:/DevWorks_HLS/Convolution_Project/Vivado/2dconv/2dconv.srcs/sources_1/bd/design_1/design_1.bd
