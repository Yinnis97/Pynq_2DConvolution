...
HD_PWD='C:/DevWorks_HLS/Convolution_Project/Vivado/pooling/Pooling.runs/design_1_Pooling_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Pooling_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Pooling_0_0.tcl
